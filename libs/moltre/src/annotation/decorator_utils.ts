...
import { ReflectResult } from '../interfaces/interfaces';
import { Metadata } from '../planning/metadata';

export function tagParameter(annotationTarget: any,
                             propertyName: string,
...
export function tagProperty(annotationTarget: any,
                            propertyName: string,
                            metadata: Metadata) {
  const metadataKey = MetadataKeys.TAGGED_PROP;
  _tagParameterOrProperty(metadataKey, annotationTarget.constructor, propertyName, metadata);
}

function _tagParameterOrProperty(metadataKey: string,
...
export function decorate(decorator: (ClassDecorator | ParameterDecorator | MethodDecorator),
                         target: any,
