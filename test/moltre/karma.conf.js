...
module.exports = (config) => {
  ...
  config.set({
    ...
    files: [
      ...
      {pattern: 'test/moltre/karma-test-shim.js', included: true, watched: false},
      ...
      {pattern: 'dist/packages/moltre/**/*', included: false, watched: true},
    ],

    customLaunchers: customLaunchers,

    preprocessors: {
      'dist/packages/moltre/**/*.js': ['sourcemap']
    },
  ...
  if (process.env['TRAVIS']) {
    ...
    if (process.env['TRAVIS_PULL_REQUEST'] === 'false' &&
      ...
      config.preprocessors['dist/packages/moltre/**/!(*+(.|-)spec).js'] = ['coverage'];
